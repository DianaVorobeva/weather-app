    ...
    <div className="mainPart">
      <h4 className="minMax">
        <span className="minTemp">
          {data ? `${Math.round(data.main.temp_min)}°C` : "4°C"}
        </span>
        /
        <span className="maxTemp">
          {data ? `${Math.round(data.main.temp_max)}°C` : "7°C"}
        </span>
      </h4>
      <h1 className="temperature">
        {data ? `${Math.round(data.main.temp)}°C` : "8°C"}
      </h1>
      <p className="conditionals">
      ...
      <div className="block1">
        ...
        <div className="box">
          <p className="box">
            ...
            <span className="humidity">{data ? data.main.humidity : "63"}</span>
            %
          </p>
        </div>
      </div>
