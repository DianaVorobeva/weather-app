import { useEffect, useState } from "react"; // fix delete unneccery
    ...
    <div className="otherInfo">
      <div className="item">
        ...
        <p className="feelsLike">
          {data ? `${Math.round(data.main.feels_like)}°C` : "8°C"}
        </p>
      </div>
      <div className="item">
        ...
        <p className="pressure">
          {data ? `${data.main.pressure}hPa` : "1010 hPa"}
        </p>
      </div>
      <div className="item">
        ...
        <p>
          <span className="visibility">
            {data ? Number(`${data.visibility}`) / 1000 : "10"}
          </span>{" "}
          km
        </p>
      </div>
        ...
        <p className="sunrise">
          {data
            ? `${
                ...
                ":" +
                new Date((data.sys.sunrise + data.timezone) * 1000).getMinutes()
              }`
            : "6:46"}
        </p>
      </div>
